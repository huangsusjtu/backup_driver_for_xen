...
static struct kmem_cache *xen_blkif_cachep;  //cache, 用于存储struct xen_blkif， 这个结构与前端Domu一一对应
...
static int blkback_name(struct xen_blkif *blkif, char *buf)  //从xen_bus中读取设备名
{
...
static void xen_update_blkif_status(struct xen_blkif *blkif)
{
	...
	blkif->xenblkd = kthread_run(xen_blkif_schedule, blkif, name);//调度进程
...
static void xen_blkif_disconnect(struct xen_blkif *blkif)// 释放资源
{
	if (blkif->xenblkd) {
